    ...
    currentItems.forEach((item, index) => {
        ...
        li.innerHTML = `
            ...
            <div class="history-item-actions">
                <button class="view-btn action-icon" data-index="${originalIndex}" title="Ver QR">
                    <i data-lucide="eye"></i>
                </button>
                
                ${isValidURL(item.text) ?
                    `<button class="open-url-btn action-icon" data-url="${item.text}" title="Abrir enlace">
                        <i data-lucide="external-link"></i>
                    </button>` : ""
                }
                
                <button class="delete-btn action-icon" data-index="${originalIndex}" title="Eliminar">
